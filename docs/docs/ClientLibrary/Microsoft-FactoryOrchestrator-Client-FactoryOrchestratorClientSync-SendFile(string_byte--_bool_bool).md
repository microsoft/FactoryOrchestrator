...
## FactoryOrchestratorClientSync.SendFile(string, byte[], bool, bool) Method
...
```
#### Parameters
<a name='Microsoft-FactoryOrchestrator-Client-FactoryOrchestratorClientSync-SendFile(string_byte--_bool_bool)-targetFilename'></a>
...
<a name='Microsoft-FactoryOrchestrator-Client-FactoryOrchestratorClientSync-SendFile(string_byte--_bool_bool)-fileData'></a>
...
<a name='Microsoft-FactoryOrchestrator-Client-FactoryOrchestratorClientSync-SendFile(string_byte--_bool_bool)-appendFile'></a>
...
<a name='Microsoft-FactoryOrchestrator-Client-FactoryOrchestratorClientSync-SendFile(string_byte--_bool_bool)-sendToContainer'></a>
