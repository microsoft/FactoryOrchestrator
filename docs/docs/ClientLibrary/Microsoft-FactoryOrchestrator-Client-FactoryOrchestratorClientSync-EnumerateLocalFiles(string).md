...
## FactoryOrchestratorClientSync.EnumerateLocalFiles(string) Method
...
```
#### Parameters
<a name='Microsoft-FactoryOrchestrator-Client-FactoryOrchestratorClientSync-EnumerateLocalFiles(string)-path'></a>
