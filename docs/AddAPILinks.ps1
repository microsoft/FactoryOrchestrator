...
$apiDocs = Get-ChildItem -Path $docPath -filter "Microsoft_FactoryOrchestrator_Core_TaskList*.md" -Recurse
$apiDocs += Get-ChildItem -Path $docPath -filter "Microsoft_FactoryOrchestrator_Core_TaskBase*.md" -Recurse
$apiDocs += Get-ChildItem -Path $docPath -filter "Microsoft_FactoryOrchestrator_Core_UWPTask.md" -Recurse
$apiDocs += Get-ChildItem -Path $docPath -filter "Microsoft_FactoryOrchestrator_Core_ExecutableTask.md" -Recurse
$apiDocs += Get-ChildItem -Path $docPath -filter "Microsoft_FactoryOrchestrator_Core_PowerShellTask.md" -Recurse
$apiDocs += Get-ChildItem -Path $docPath -filter "Microsoft_FactoryOrchestrator_Core_ExternalTask.md" -Recurse
$apiDocs += Get-ChildItem -Path $docPath -filter "Microsoft_FactoryOrchestrator_Core_TaskRun*.md" -Recurse
$apiDocs += Get-ChildItem -Path $docPath -filter "Microsoft_FactoryOrchestrator_Client_FactoryOrchestratorClient_*.md" -Recurse
$apiDocs += Get-ChildItem -Path $docPath -filter "Microsoft_FactoryOrchestrator_Client_ServerPoller-*.md" -Recurse
